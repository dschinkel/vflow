# <span style="color:#76a039">/hexagonal Skill Pair Implementation Plan</span>
...
| `docs/superpowers/specs/skills/hexagonal/2026-05-17-hexagonal-architecture-skill.md` | Modify | Replace plan-link placeholder |

No new hooks. No bash tests. Spec doesn't require any.

---

## <span style="color:#76a039">Implementation Decisions Locked Down</span>
...
## <span style="color:#76a039">Task 1: Cross-link spec → plan</span>

**Files:**
- Modify: `docs/superpowers/specs/skills/hexagonal/2026-05-17-hexagonal-architecture-skill.md:3`
...
```markdown
> **Plan:** [/hexagonal Skill Pair Implementation Plan](../../../plans/skills/2026-05-17-hexagonal-architecture-skill.md)
```

Note the `../../../` — the spec lives at `docs/superpowers/specs/skills/hexagonal/`, three levels below `docs/superpowers/`, so the path to `plans/skills/` climbs three directories.

- [ ] **Step 2: Verify the link resolves**

Run:
```bash
ls docs/superpowers/plans/skills/2026-05-17-hexagonal-architecture-skill.md
```
...
## <span style="color:#76a039">Task 2: Create `commands/hexagonal.md` (core skill)</span>
...
## <span style="color:#76a039">Task 3: Create `commands/hexagonal-scaffold.md` (operation)</span>
...
### <span style="color:#76a039">`domain/` (not present — add only when needed)</span>
...
## <span style="color:#76a039">Pseudocode</span>
...
````markdown
### <span style="color:#76a039">Data adapter (driven)</span>
...
### <span style="color:#76a039">Repository (port)</span>
...
### <span style="color:#76a039">Use case (application logic)</span>
...
### <span style="color:#76a039">Controller (driving adapter)</span>
...
### <span style="color:#76a039">Style rules baked into these examples</span>
...
```markdown
## <span style="color:#76a039">Style Conventions (from reference codebase)</span>
...
## <span style="color:#76a039">Task 4: Mirror both files to `.claude/commands/`</span>
...
## <span style="color:#76a039">Task 5: Stage everything and stop before commit</span>

**Files:**
- All files from Tasks 1–4 plus `docs/superpowers/plans/skills/2026-05-17-hexagonal-architecture-skill.md`.

- [ ] **Step 1: Stage the seven files**

```bash
git add \
  docs/superpowers/specs/skills/hexagonal/2026-05-17-hexagonal-architecture-skill.md \
  docs/superpowers/plans/skills/2026-05-17-hexagonal-architecture-skill.md \
...
## <span style="color:#76a039">Task 6: End-to-end smoke verification</span>
...
```bash
grep "Plan:" docs/superpowers/specs/skills/hexagonal/2026-05-17-hexagonal-architecture-skill.md
```
Expected: a line containing `[/hexagonal Skill Pair Implementation Plan](../../../plans/skills/2026-05-17-hexagonal-architecture-skill.md)`.

- [ ] **Step 5: Verify the plan cross-link is in place**

```bash
grep "Spec:" docs/superpowers/plans/skills/2026-05-17-hexagonal-architecture-skill.md | head -1
```
Expected: a line containing `[Hexagonal Architecture Skill — Design Spec](../specs/skills/hexagonal/2026-05-17-hexagonal-architecture-skill.md)`.
...
## <span style="color:#76a039">Self-Review</span>
...
- Cross-link directory math: spec lives at `docs/superpowers/specs/skills/hexagonal/` so plan link uses `../../../plans/skills/`. Plan lives at `docs/superpowers/plans/skills/` so spec link uses `../../specs/skills/hexagonal/`. Verified in Tasks 1 and the plan header.
...
## <span style="color:#76a039">Out of Scope (deferred to future plans)</span>
