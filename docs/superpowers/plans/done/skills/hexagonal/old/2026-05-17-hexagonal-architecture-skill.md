# <span style="color:#76a039">Hexagonal Architecture Skill — Implementation Plan</span>

> **Status:** Done — superseded by the unified [Hexagonal Skill Pair Implementation Plan](../../../skills/2026-05-17-hexagonal-architecture-skill.md) (one plan covering both core + scaffold). Both `/hexagonal` and `/hexagonal-scaffold` are now shipped.
>
...
## <span style="color:#76a039">Task 1: Write hexagonal.md (core skill)</span>
...
```python
# <span style="color:#76a039">use_cases/generate_images.py</span>
...
```python
# <span style="color:#76a039">repositories/listing_repository.py</span>
...
```python
# <span style="color:#76a039">controllers/listing_controller.py</span>
...
## <span style="color:#76a039">Task 2: Smoke test hexagonal skill</span>
