# <span style="color:#76a039">Refactor Command Implementation Plan</span>

> **Status:** Done — original `/refactor` build plan. `/refactor` has since gained the `--output <dir>` flag; see `commands/refactor.md` for current behavior.
>
> **Specs:** [Refactor Skill — Research Notes](../../../specs/done/skills/refactor/2026-05-14-research-refactor-skill.md) · [Naming Research](../../../specs/done/skills/refactor/2026-05-14-research-refactor-skill_naming.md)
...
## <span style="color:#76a039">Task 1: Command Directory Structure ✅</span>
...
## <span style="color:#76a039">Task 2: Command File — Invocation & Basic Session Setup ✅</span>
...
## <span style="color:#76a039">Task 3: Command File — Processing Strategy ✅</span>
...
## <span style="color:#76a039">Task 4: Command File — Proposal Format & Accept/Reject Flow ✅</span>
...
## <span style="color:#76a039">Task 5: Command File — Session Log Format ✅</span>
...
## <span style="color:#76a039">Task 6: Command File — Tree Diagram Generation ✅</span>
...
## <span style="color:#76a039">Task 7: Smoke Test</span>
...
## <span style="color:#76a039">Task 8: Scoped Output Path Naming ✅</span>
...
## <span style="color:#76a039">Task 9: Experiment Block in Session Log ✅</span>
...
## <span style="color:#76a039">Task 10: Hypothesis & Prediction Prompts at Session Start ✅</span>
...
## <span style="color:#76a039">Task 11: Stop Hook — Total Tokens Auto-Fill ✅</span>
...
## <span style="color:#76a039">Task 12: At Session End — Analysis (approve/reject flow) ✅</span>
...
## <span style="color:#76a039">Task 13: Naming Principles as Standalone Section ✅</span>
...
## <span style="color:#76a039">Task 14: Detailed Mermaid Tree Diagram ✅</span>
...
## <span style="color:#76a039">Task 15: Error Handling ✅</span>
