# <span style="color:#76a039">/tdd Skill Implementation Plan</span>

> **Spec:** [TDD Skill — Design Spec](../../../specs/done/skills/2026-05-17-tdd-skill-design.md)
...
| `docs/superpowers/specs/skills/2026-05-17-tdd-skill-design.md` | Modify | Replace the plan-link placeholder at the top |
...
**Files:**
- Modify: `docs/superpowers/specs/skills/2026-05-17-tdd-skill-design.md:3`
...
```markdown
> **Plan:** [/tdd Skill Implementation Plan](2026-05-17-tdd-skill-design.md)
```
...
## <span style="color:#76a039">Task 2: Add `--output <dir>` override to `/refactor`</span>
...
## <span style="color:#76a039">Task 3: Create the `/tdd` skill — full file</span>
...
```markdown
# <span style="color:#76a039">TDD Plan — <task name></span>
...
## <span style="color:#76a039">Increment 1 — <behavior name in domain language></span>
...
## <span style="color:#76a039">Increment 2 — ...</span>

(repeat as many increments as the task warrants)

---

## <span style="color:#76a039">Cleanup & Verification</span>
...
```markdown
# <span style="color:#76a039">TDD Implementation — <task name></span>
...
```markdown
## <span style="color:#76a039">Increment <N> — <behavior name></span>
PLAN STEP: <N>
...
## <span style="color:#76a039">Task 4: Mirror `commands/tdd.md` and `commands/refactor.md` into `.claude/commands/`</span>
...
## <span style="color:#76a039">Task 5: Add `.tdd-context.json` to `.gitignore` and commit everything</span>
...
```bash
git add \
  docs/superpowers/specs/skills/2026-05-17-tdd-skill-design.md \
...
## <span style="color:#76a039">Task 6: Verify end-to-end smoke (no execution)</span>
...
```bash
grep "Plan:" docs/superpowers/specs/skills/2026-05-17-tdd-skill-design.md
```
...
```
Expected: a line containing `[TDD Skill — Design Spec](../specs/skills/2026-05-17-tdd-skill-design.md)`.
