# Hexagonal Skill — Invocation Modes (Brainstorm In Progress)

> **Parent spec:** [Hexagonal Architecture Skill — Design Spec](2026-05-17-hexagonal-architecture-skill.md)
>
...
### Decision 1 — `/feature` always invokes `/hexagonal` explicitly
...
### Decision 2 — Greenfield and brownfield are distinct invocation modes
...
### Decision 3 — `/feature` passes the target service explicitly
...
### Q2 — Does brownfield mode prompt for language?
...
### Q3 — Does brownfield mode use the optional `@<reference-path>` argument?
...
### Q4 — Does brownfield mode write any artifacts?
...
### Q5 — How does `/hexagonal` hand inferred style notes back to the caller?
...
## Implications for Other Specs (When Decisions Land)

### Parent hexagonal spec ([link](2026-05-17-hexagonal-architecture-skill.md))
