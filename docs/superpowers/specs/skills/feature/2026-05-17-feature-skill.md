# <span style="color:#76a039">Feature Skill — Design Spec</span>

> **Plan:** [feature-ui](../../../plans/feature/2026-05-18-feature-ui.md) · [feature skill](../../../plans/feature/2026-05-18-feature-skill.md)
>
> **Related specs:**
> - [Hexagonal Architecture Skill](../../done/skills/hexagonal/2026-05-17-hexagonal-architecture-skill.md) — sub-skill invoked per non-cosmetic sticky
> - [Hexagonal Invocation Modes — brainstorm in progress](../../../../todo/2026-05-17-hexagonal-invocation-modes.md) — refines how `/hexagonal` is invoked from `/feature` (greenfield vs brownfield)
> - [TDD Skill](../../done/skills/2026-05-17-tdd-skill-design.md) — sub-skill invoked per non-cosmetic sticky as the code-writing driver
> - [Claude Design — research notes](../../other/2026-05-17-claude-design-research.md) — why we decided not to depend on Claude Design for v1
...
## <span style="color:#76a039">Design References</span>
...
## <span style="color:#76a039">UI Stack and Distribution</span>
...
### <span style="color:#76a039">Stack</span>
...
### <span style="color:#76a039">Lifecycle</span>
...
### <span style="color:#76a039">Atomic design organization</span>
...
> **Why not Claude Design?** Documented in the [Claude Design research spec](../../other/2026-05-17-claude-design-research.md). Short version: it's a hosted prototyping product, not an installable library; no clean export path; output not shaped for hardened distributed code.

---

## <span style="color:#76a039">Four Phases</span>

### <span style="color:#76a039">Phase 1 — Drafter</span>
...
### <span style="color:#76a039">Phase 2 — Provocateur</span>
...
### <span style="color:#76a039">Phase 3 — Persist</span>
...
### <span style="color:#76a039">Phase 4 — Implement, sticky by sticky</span>
...
#### <span style="color:#76a039">Per-sticky classification (one-time at Phase 4 start)</span>
...
#### <span style="color:#76a039">Per-sticky implementation flow (scope-driven)</span>
...
## <span style="color:#76a039">Sub-Skill Composition</span>
...
### <span style="color:#76a039">Composition contract — `.tdd-context.json`</span>
...
`/tdd` detects the state file's presence as the feature-invoked signal and automatically uses **outside-in** (skips the direction question). `/tdd`'s opt-in question is still asked — `cosmetic` stickies bypass `/tdd` entirely, so the opt-in only fires for non-cosmetic stickies.

`targetService` and `scope` are **not** written to the state file — they are `/feature`'s internal routing data. `/feature` uses `scope` to decide which sub-skills to invoke and which layer to start from before ever calling `/tdd`. `/tdd` doesn't need to know about them.

**Cross-reference:** The brownfield invocation surface for `/hexagonal` is still being designed in the [Hexagonal Invocation Modes brainstorm](../../../../todo/2026-05-17-hexagonal-invocation-modes.md). `/feature` passes `targetService` directly when invoking `/hexagonal`; it never flows through the state file.

---

## <span style="color:#76a039">Story Map UI</span>
...
## <span style="color:#76a039">Storage and Portability</span>
...
## <span style="color:#76a039">Future Features</span>
...
## <span style="color:#76a039">Brainstorm In Progress — Open Questions</span>
...
### <span style="color:#76a039">UI behavior</span>
...
### <span style="color:#76a039">Visual layer</span>
...
### <span style="color:#76a039">Composition</span>
...
### <span style="color:#76a039">Repo structure</span>
...
### <span style="color:#76a039">Sibling specs</span>
- [Hexagonal Invocation Modes brainstorm](../../../../todo/2026-05-17-hexagonal-invocation-modes.md) — open questions about brownfield invocation surface for `/hexagonal`.
