# <span style="color:#76a039">TDD Skill — Design Spec</span>
...
## <span style="color:#76a039">Context Passing — Option A + B Hybrid</span>
...
## <span style="color:#76a039">Log Location</span>
...
### <span style="color:#76a039">Question 2 — Direction (only if yes)</span>
...
### <span style="color:#76a039">Conductor mode — no plan review (auto-drives)</span>
...
### <span style="color:#76a039">Human-in-the-loop mode (user said yes to plan review)</span>
...
### <span style="color:#76a039">Hard rules — enforced in both modes, no exceptions</span>
...
### <span style="color:#76a039">Cleanup & Verification (final step)</span>
...
### <span style="color:#76a039">Case B — Unexpected termination</span>
...
### <span style="color:#76a039">`.tdd-context.json` — additional fields required</span>
...
## <span style="color:#76a039">Approaches Considered</span>

### <span style="color:#76a039">Approach 1 — Setup wizard only *(not selected)*</span>
...
### <span style="color:#76a039">Approach 2 — Full session conductor *(selected)*</span>
...
### <span style="color:#76a039">Approach 3 — Plan-heavy with all increments upfront *(not selected)*</span>
