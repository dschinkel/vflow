# <span style="color:#76a039">Refactor Skill — Research Notes</span>

> **Plans:** [Refactor Command Implementation Plan (done)](../../../../plans/done/skills/2026-05-14-refactor-skill.md) — original `/refactor` build plan; `/refactor` has since gained the `--output <dir>` flag, see `commands/refactor.md` for current behavior. · [Stop Hook Cleanup Trap](../../../../plans/done/skills/2026-05-15-stop-hook-cleanup-trap.md)
_2026-05-14_
...
## <span style="color:#76a039">What This Skill Does</span>
...
## <span style="color:#76a039">Skill Format</span>
...
## <span style="color:#76a039">Notes (from Anthropic Skills Guide)</span>
...
### <span style="color:#76a039">Description field</span>
...
### <span style="color:#76a039">`allowed-tools` frontmatter</span>
...
### <span style="color:#76a039">Command file size</span>
...
### <span style="color:#76a039">No longer relevant</span>
...
## <span style="color:#76a039">Global Naming Knowledge Base</span>
...
### <span style="color:#76a039">Two-layer design</span>
...
### <span style="color:#76a039">How it connects to session logs</span>
...
## <span style="color:#76a039">Custom Hooks</span>
...
### <span style="color:#76a039">start-refactor-skill.sh (`UserPromptSubmit`)</span>
...
### <span style="color:#76a039">end-refactor-log-session-stats.sh (`Stop`)</span>
