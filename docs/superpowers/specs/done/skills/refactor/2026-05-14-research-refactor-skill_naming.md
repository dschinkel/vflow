# <span style="color:#76a039">Refactor Skill — Naming Research Notes</span>

> **Plan (done):** [Refactor Command Implementation Plan](../../../../plans/done/skills/2026-05-14-refactor-skill.md) — original `/refactor` build plan. `/refactor` has since been enhanced with the `--output <dir>` flag (see `commands/refactor.md` for current behavior).
_2026-05-14_
...
## <span style="color:#76a039">Processing Strategy (Inside-Out)</span>
...
## <span style="color:#76a039">Hypothesis & Analysis</span>
...
### <span style="color:#76a039">On Start — Hypothesis Prompt</span>
...
### <span style="color:#76a039">At Session End — Analysis, Verdict & Learnings</span>
...
### <span style="color:#76a039">In the Session Log</span>
...
### <span style="color:#76a039">Flat Log</span>
...
#### <span style="color:#76a039">How Automatic Token Tracking Works</span>
...
### <span style="color:#76a039">Refactor Names Tree Diagram (claude-mermaid)</span>
...
## <span style="color:#76a039">Quality Scoring Ideas</span>
...
### <span style="color:#76a039">1. Depth-of-change per rename</span>
...
### <span style="color:#76a039">2. Pre/post quality baseline</span>
...
### <span style="color:#76a039">3. Anti-pattern hit rate</span>
...
## <span style="color:#76a039">Capturing Rename Feedback in the Session Log</span>
...
### <span style="color:#76a039">The problem</span>
...
### <span style="color:#76a039">Option A: Inline annotation</span>
...
### <span style="color:#76a039">Option B: Separate `## Feedback` section</span>
