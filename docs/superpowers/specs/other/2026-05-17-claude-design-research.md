# <span style="color:#76a039">Claude Design — Research Notes</span>
...
## <span style="color:#76a039">What it is</span>
...
## <span style="color:#76a039">Key capability — design-system extraction</span>
...
## <span style="color:#76a039">Atomic design relationship</span>
...
## <span style="color:#76a039">Why it's not a fit for the `/feature` story map UI (v1)</span>
...
## <span style="color:#76a039">How it could still help, indirectly</span>
...
## <span style="color:#76a039">Was considered as the in-CLI brainstorming companion</span>
...
## <span style="color:#76a039">Decision recorded for `/feature` v1</span>
...
## <span style="color:#76a039">Open questions to revisit later</span>
...
## <span style="color:#76a039">Sources</span>
